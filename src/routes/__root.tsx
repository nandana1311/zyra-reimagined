  ...
  head: () => ({
    meta: [
      ...
      { title: "Zyra by Anna — Elegance in Every Detail" },
      {
        name: "description",
        content:
          "Zyra by Anna — luxury, editorial fine jewelry. Discover handcrafted rings, necklaces and earrings designed with timeless elegance.",
      },
      { name: "author", content: "Zyra by Anna" },
